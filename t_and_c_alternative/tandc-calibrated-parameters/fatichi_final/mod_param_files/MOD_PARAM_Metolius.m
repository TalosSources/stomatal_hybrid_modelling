...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%The overstory is almost exclusively composed of ponderosa pine trees (Pinus ponderosa Doug. Ex P. Laws) 
%with a few scattered incense cedars (Calocedrus decurrens (Torr.) Florin) and has a peak leaf area index (LAI) of 2.8 m2 m-2. 
%Tree height is relatively homogeneous at about 16 m, and the mean tree density is approximately 325 trees ha-1 (Irvine et al., 2008). 
%The understory is sparse with an LAI of 0.2 m2 m-2 and primarily composed of bitterbrush (Purshia tridentate (Push) DC.) and Manzanita 
%(Arctostaphylos patula Greene). Soils at the site are sandy (69%/24%/7% sand/silt/clay at 0–0.2 m depth and 66%/27%/7% at 0.2–0.5 m depth, 
%and 54%/ 35%/11% at 0.5–1.0 m depth), freely draining with a soil depth of approximately 1.5 m (Irvine et al., 2008; Law et al., 2001b; Schwarz et al., 2004).

%Ponderosa pine (Pinus ponderosa) 2.8 14 32 Sandy loam

%US-Me2 is the Metolius intermediate-aged ponderosa pine forest in central Oregon (Thomas et al., 2009).
%The years 2002–2003 were anomalously dry and 2006 was anomalously wet.
%GPP 1500 gC/m2 
...
Oice = 0;
%%%%%%%%%%%%%
Zs= [0 10 20 50 100 150 200 300 400 500 600 700 800 1000 1200 1400 1500 ]; %% ms+1
Zdes = 10;
Zinf=  10;
Zbio = 250; 
...
age_cr_H= [1050]; %% [day] Critical Leaf Age
