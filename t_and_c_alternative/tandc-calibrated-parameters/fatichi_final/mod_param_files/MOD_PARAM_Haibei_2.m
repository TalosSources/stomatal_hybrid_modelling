...
%%%% CN-Ha2: Haibei Shrubland (3357)  Wrong name as it should be the third tower on swamp meadow


% This station represents a typical alpine meadow ecosystem type in the northeast of Tibetan plateau.
%Kobresia tibetica swamp meadow mainly distributed in the valley where the drainage is impeded and the soil humidity is very high.
% Accompanying species include Blysmus sinocompressus Carex atrofusca Carex moorgropt Gentianopsis paludosa Pedicularis longiflora subsp.
% tubiformis Primula nutans GeorgiSaussurca stilla,etc. The vegetation coverage can reach to 88% at the end of growing season. Average height is 25 cm, 
% the NPP is between 229-347 g/m2 and the average NPP is 300.1 g/m2. Content of organic matter and nitrogen of the soil in 0-40 cm is 28.08% and 1.27% respectively.
