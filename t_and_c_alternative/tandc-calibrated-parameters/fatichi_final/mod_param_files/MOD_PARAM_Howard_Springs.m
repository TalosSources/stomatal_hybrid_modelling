...
%% Eucalyptos  ;; Sorghum 
% Clay = 15 Silt 37 Sand 60  -- Ks = 10 mm/h 
% Tree height 18
%GPP = 2000 gC/m2 
%LAI=1.5 1.2 - 0.4 
%Ta = 26  Pr =1468 / 1700  ET = 1135 
%% Soil 15 m  Tree root depth 5 m  -- Sorghum 1m 
%%% tower heright 23 m 
%% 55 tree cover 
...
rjv_H=[1.9 1.9]; %%% Scaling Jmax - Vmax  [umol electrons / umolCO2 ] 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% LOW VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_L = [0.012 0.012]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
LDay_min_L =[10 10]; %% Day duration for leaf onset
...
%%%%%%%%%%%%%%%%
LAI_H(1,:)=[2.6 0.0]; %
B_H(1,:,:)= [275 403 530 270 30 0 4 0 ;0 0 0 0 0 0 0 0]; %%
Rrootl_H(1,:)= [5091 0] ;
PHE_S_H(1,:)=[3 1];
dflo_H(1,:)=[127 0];
AgeL_H(1,:)=[252 0];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
LAI_L(1,:)=[0.0 1.0];
B_L(1,:,:)= [0 0 0 0 0 0 0 0 ; 83 0 207 157 11 0 4 0 ];
Rrootl_L(1,:)= [1666 1666] ;
PHE_S_L(1,:)=[0 3];
dflo_L(1,:)=[0 31 ];
AgeL_L(1,:)=[0 19];
e_rel_L(1,:)=[1 1];
...
%%%%%%%%%%
%%%%
PARI_H(1,:,:)= [121.56 122.95  -0.22 ; 0 0 0];
NBLI_H(1,:)=   [0.9089 0];
...
%%%%%%%%%%%%%% Volume [mm]
%%%%%%%%%%%%%%%%%%%%%
O(1,:)=  [ 0.1919    0.1968    0.2010    0.2050    0.2084    0.2127    0.2173    0.2213    0.2250    0.2276    0.2293    0.2299    0.2294    0.2275, ... 
    0.2202    0.1862    0.1335    0.0992    0.1035    0.1074    0.1108    0.1218    0.1582    0.1883    0.2036    0.2045    0.2158];
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
V(1,:) = (O(1,:) -Ohy).*dz;
