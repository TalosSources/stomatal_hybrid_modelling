...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Sizwang-grazed  CN-Sw2  Pr=180 Ta 3.4 
%   The native vegetation belongs to desert steppes, dominated by Stipa breviflora, Cleistogenes songorica and Artemisia frigid
% Height Veg. 10-20 cm 

%Stipa breviflora Temperate continental
%GPP = 124   ET = 116 Growing Season 213 - 273
%Chenozemic soil
%Height Veg 0.25 - 0.08 (natural/grazed)
%Standing Aboveground Biomass 118 81
%Standing Beloweground Biomass 437 163
%LAI 0.7   0.6
% Coverage 47-25% 
%stocking rate: 5–10 sheep-unit month ha?1)   1.8 sheep·ha?1·0.5 yr?1 f 
%loamy sand texture.  2 m height measurments 
%%%%%%%%%%%%%%%%%
cur_dir=cd;
cd(Directory)
...
Sl_L = [0.016   0.012]; %  [m^2 gC] specific leaf area of  biomass [m^2 /gC] 0.05 -0.005
...
Bfac_ls_L= [0.15  NaN] ; % Not-used 
Tlo_L = [-1.5  5]; %% Mean Temperature for Leaf onset
Tls_L = [NaN  NaN]; %% Not-used 
PAR_th_L= [Inf Inf]; %% Light Phenology Threshold 
dmg_L= [20  15]; %%%  Day of Max Growth
...
LDay_cr_L = [11.8  11.8]; %%%  Threshold for senescence day light [h]
...
%%%%%%%%%%%%%%%%%%%%%
LAI_L(1,:)=[0.0 0];
B_L(1,:,:)= [0 0 414 295 1 0 175 0; 
     347 664 699 492 1 0 16 0];
...
Ts(1)=Ta(1)+1;
Tdamp(1)=Ta(1);
Tdp(1,:)= [  -1.0166   -0.9673   -0.8783   -0.9055   -1.0742   -1.3629   -1.9980   -2.7938   -3.4078   -3.7798   -4.0447   -4.0683   -4.0322   -4.0107];
TdpI_H(1,:)= -0.5242;
TdpI_L(1,:)= -0.5242;
...
Ws_under(1)=1;
%%%%%%%%%%%%%% Volume [mm]
O(1,:)= [    0.0278    0.0267    0.0375    0.0337    0.0545    0.0736    0.0893    0.1136    0.1249    0.1307    0.1373    0.1422,...
    0.1460    0.1478]; 
%%%%%%%%%%%%%%%%%%%
V(1,:) = (O(1,:) -Ohy).*dz;
%%%%%%%%%%%%%%%%%
