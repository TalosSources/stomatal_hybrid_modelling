...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%US-Skr 
%Long Term Ecological Research (FCE LTER, site SRS6) program and the US Geological Survey (site SH3).
%Rhizhophora mangle, Avicennia germinans, and Laguncularia racemosa,
%Tower 27m
%Canopy height 19 m
%% GPP 3.6-7.2 gC m-2 day seasonally  
%%% Albedo 0.12-0.14 
% LAI 3.0 
...
Oice = 0;
%%%%%%%%%%%%%%%%%%%
Zs= [0 10 50 100 200 300 400 500 600 700 800 1000 ]; %%% [ms+1] 
Zdes=10;
Zinf=10;
Zbio = 250; 
...
Psi_sto_00_H =  -3.0; %% [MPa]  Water Potential at 2% loss conductivity
Psi_sto_50_H =  -5.0 ;%% [MPa]  Water Potential at 50% loss conductivity
%%% Leaf
PsiL00_H =  -5.0; %% [MPa]  Water Potential at 2% loss conductivity
PsiL50_H =  -5.8 ;%%[MPa]  Water Potential at 50% loss conductivity
...
Tlo_H=19; %% Mean Temperature for Leaf onset
Tls_H=[NaN]; %% Mean Temperature for Leaf Shed
PAR_th_H= 0.75; 
dmg_H=45; %%%  Day of Max Growth
LAI_min_H=0.001;
Trr_H=0.5; %% Translocation rate [gC /m^2 d]
mjDay_H=370; %% Maximum Julian day for leaf onset
LDay_min_H=11.5; %% Minimum Day duration for leaf onset
...
Tlo_L=11.5; %% Mean Temperature for Leaf onset
...
LtR_L=0.9; %%% Leaf to Root ratio maximum
...
LDay_cr_L=11.2; %%%  Threshold for senescence day light [h]
...
%%%%
PARI_H(1,:,:)= [ 62.6752   66.2192 -3.5953];
NBLI_H(1,:)= 0.3987;
PARI_L(1,:,:)=[0 0 0]; 
NBLI_L(1,:)=0;
%%%%
