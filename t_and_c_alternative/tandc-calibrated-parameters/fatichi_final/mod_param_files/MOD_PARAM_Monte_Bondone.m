% Monte Bondone  Grassland 
% 
% grassland is dominated by the Nardetum alpigenum and is managed as a meadow with one cut per year in July. 
% The maximum canopy height at the peak of the growth period (mid June to early July) can reach up to 30 cm
% GPP  1400   LAI 2.8 
% Cut 1 time per year 
% Tower height mounted at 2.5 m height 
% fine loamy texture 
%%%%%%%%%%%%%%%%%
cur_dir=cd;
cd(Directory)
...
%%% LOW VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_L = [0.023]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
