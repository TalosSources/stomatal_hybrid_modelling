%Scots pine forest site
%Tower height 24m 
%%% Scots pine (Pinus sylvestris) Pinus sylvestris (89%) on a sandy soil with a relatively deep groundwater table 6.5 m below the surface.
%The average tree height is 15.1 m.
%LAI	1.7 - 2.2
%Rain 962
%ET 532
%the gross primary production (GPP) of this forest to 1559 g C m?2 per year. 
%%% Planted 1910 
%%% Leaf Litter production 255
% Standing leaf biomass 151
%Leaf C/N 30.4 
%%% Specific leaf area 0.0094 
%%% Sand 0.60 Clay 0.01 SOM 0.02 
...
Oice = 0;
%%%%%%%%%%%%%
Zs= [0 10 20 50 100 200 300 400 600 800 1000 1200 1500 2000 2500 3000 3500 4000 4500 5000 5500 6000]; %% ms+1
Zdes = 10;
Zinf=  10;
Zbio = 250; 
...
Nl_H= [31]; %[gC/gN ] Leaf Carbon-Nitrogen ratio 
...
Tlo_H = [8.2]; %% Mean Temperature for Leaf onset
...
LDay_min_H =[13.6]; %% Minimum Day duration for leaf onset
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LAI_H(1,:)=[2.2]; %
B_H(1,:,:)= [220 741 440 486 6 0 12 0]; %%
Rrootl_H(1,:)= [4200] ;
PHE_S_H(1,:)=[1];
dflo_H(1,:)=[0];
AgeL_H(1,:)=[700];
...
Ws_under(1)=1; 
%%%%%%%%%%%%%% Volume [mm]
O(1,:)= [0.1821    0.1829    0.1841    0.1845    0.1817    0.1790    0.1745    0.1639    0.1636    0.1669    0.1701    0.1737    0.1791 0.1834    0.1855    0.1833    0.1694    0.1490    0.1415    0.1407    0.1405];
%%%%%%%%%%%%%%%%%%%
V(1,:) = (O(1,:) -Ohy).*dz;
%%%%%%%%%%%%%%%%%
cd(cur_dir)
