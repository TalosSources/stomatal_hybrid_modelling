...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% Grass forage (Brachiaria brizantha) Panicum maximum  C4 grasses 
%%% 8-9m tower   7m soil depth ;;  0.2-0.5 m veg. height %% 
%% grass can grow up to 0.6-1.5 m  20mm leaf width 
%%% seeded 2-4 kg/ha  responsive to N fertilizer   dry-matter product. 8-20 ton/ha/yr 
%% LAI  (1.2-2.1) 1.4  - 2.8   90 cm root depth 
%3-4 cattle /ha per 3-4 months per year  // GPP 2200 2300 
%%% Sla 0.012 - 0.015  
%%% Albedo 0.18-0.20 
%%%% LAI 3.9 ;;  GPP 8.0 gC/m2 day -- 2900  // 4000 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Psi_sto_50_L = -2.6;%  %% [MPa]  Water Potential at 50% loss conductivity
%%% Leaf
...
%%% LOW VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_L = [0.016]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
%Mpar_L(1).jDay_cut=[1:95];
%Mpar_L(1).LAI_cut=[-2.3]; %% Grazing %% 3/4 cattle/ ha  per 3-4 months
Mpar_L(1).jDay_cut=[1:365];
Mpar_L(1).LAI_cut=[-0.59]; %% Grazing spread on the year
%%%%%%
%%%%%%%%%%%% PRODUCTIVITY
Vmax_H = [0]; %
Vmax_L = [58]; % 22 without grazing --- 
%%%%%%%%%%%%%%%%%%%%%%
%%%% Sim. GPP =4180 & LAI =3.12 without grazing and with Ccover = 1 
