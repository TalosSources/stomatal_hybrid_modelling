...
%The Noè site is located within a nature reserve called “Le Prigionette” (40.60613°
%N; 8.15146° E, 27 m.a.s.l.). The area is part of the Capo Caccia peninsula, in
%North-Western Sardinia, near the town of Alghero. The nature reserve, with a surface
%area of approximately 1,200 ha, is delimited by a cliff dropping to the sea on
...
%and 24 °C in August). The average annual precipitation is 588 mm, mainly concentrated
%during the spring season. In the course of the autumn intense rainstorms
%often occur with high runoff and low water storage.
%The main species are juniper (Juniperus phoenicea L.), lentisk (Pistacia
...
%abandonment in 1970. Currently, this area has limited human activity. The average
%maquis height ranges between 0.93 and 1.43 m, and the ground cover varies
...
Tlo_L = [11.0 11.0]; %% Mean Temperature for Leaf onset 
...
LDay_cr_L = [10.2 10.2] ; %[11.0 11.0]; %%%  Threshold for senescence day light [h] [12.4 12.4]
...
%%%
LAI_L(1,:)=[2.5 1.6];
B_L(1,:,:)= [ 179 323 358 198 0 0 10 0; 
     128 201 257 131 0 0 8 0];
