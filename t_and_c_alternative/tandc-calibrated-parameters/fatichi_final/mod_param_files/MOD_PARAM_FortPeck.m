...
Zs = [ 0 10 20 50 100 150 200 300 400 500 600 800 1000 1300 1500 1750 2000 2500 3000 ];% 3500 4000 5000 6000 7000 8000 10000]; %%% [ms+1]
Zdes = 10;
Zinf=  10;
Zbio = 250; 
...
%%% Leaf
PsiL00_L =  [-1.1 -1.1]; %% [MPa]  Water Potential at 2% loss conductivity
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% C3 -- C4
Sl_L = [0.018 0.018]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
drn_L=  [1/950 1/1050]; %% turnover root  [1/d]
...
Tlo_L = [2.0 2.0]; %% Mean Temperature for Leaf onset
...
LDay_min_L =[10.5 10.5]; %% Minimum Day duration for leaf onset
...
LDay_cr_L = [10.0 10.0]; %%%  Threshold for senescence day light [h] [12.4 12.4]
...
Mpar_L(2).jDay_cut=[160:240];
Mpar_L(1).LAI_cut=[-0.8]; %% Grazing %%
Mpar_L(2).LAI_cut=[-0.8]; %% Grazing %%
%%%%%%%%%%%% PRODUCTIVITY
Vmax_H = [0 0];
Vmax_L = [65 40];
%%%%%%%%%%%%%%%%%%%%%%
...
%%%
LAI_L(1,:)=[0.0 0.0];
B_L(1,:,:)= [ 0 0 160 90 0 0 60 0; 0 0 320 240 0 0 80 0];
PHE_S_L(1,:)=[1 1 ];
dflo_L(1,:)=[0 0 ];
AgeL_L(1,:)=[25 25 ];
e_rel_L(1,:)=[1 1];
