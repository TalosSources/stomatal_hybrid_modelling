...
%% Tropical Forest  - Ankasa - Ghana 
% 
% Tower 65 m 
%% Tree 35-45-48 
%Soil:  Sand 56-60%  Clay 15-26% 
% 
% Cynometra ananta, Heritiera utilis, Gluema ivorensis
% 
% GPP = 4000 NPP = 1450  Biometric 
% GPP = 2600 Flux 
% 225-230 gC m-2 leaf biomass 
% 280-316 gC m-2 fine root 
...
Oice = 0;
%%%%%%%%%%%%%%%%%%%
Zs= [0 10 50 100 200 300 400 600 800 1000 1250 1500 1750 2000 2500 3000 3500 4000 4500 5000 5500 6000 6500 7000 8000 9000 10000]; %%% [ms+1] 
Zdes = 10;
Zinf = 10; 
Zbio = 250; 
...
%%% HIGH VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_H = [0.020]; % 0.018 %% 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
%LAI_max_H= [2.0 10.0];
aSE_H= [3]; %%% Plant Type -- 1 Seasonal Plant --  0 Evergreen  -- 2 Grass species --  3 Trop Eve. For. 
...
PAR_th_H= 0.75; 
dmg_H= [45]; %%% 60 Day of Max Growth
LAI_min_H = [0.001];
Trr_H = [0.5]; %%    Translocation rate [gC /m^2 d]
mjDay_H =370;% -120; %% Maximum Julian day for leaf onset
LDay_min_H = [10.0]; %% Minimum Day duration for leaf onset
LtR_H = [0.85]; %%% Leaf to Root ratio maximum 
...
dd_max_L=  [1/600];%%%0.005  [1/d]  0.0250 -- 0.005-0.025 death maximum for drought
...
%%%%%%%%%%%%%%%%
LAI_H(1,:)=[4.46]; %
B_H(1,:,:)= [235 606 277 406 30 0 16 0]; %%
Rrootl_H(1,:)= [2500] ;
PHE_S_H(1,:)=[3];
dflo_H(1,:)=[81];
AgeL_H(1,:)=[249];% 365
...
%%%%
PARI_H(1,:,:)= [ 76.9487 75.7892  0.8004];
NBLI_H(1,:)=1.2233;
PARI_L(1,:,:)=[0 0 0]; 
NBLI_L(1,:)=0;
%%%
