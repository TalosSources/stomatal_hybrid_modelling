...
Oice = 0;
%%%
Zs= [0 10 50 100 150 200 300 400 500 600 700 800 1000 1200 1500 2000]; %%% [ms+1] 
Zdes = 10;
Zinf=  10; 
Zbio = 250; 
...
%%% Stomata -1 -3.8 
Psi_sto_00_H =  -1.0; %% [MPa]  Water Potential at 2% loss conductivity
Psi_sto_50_H =  -3.5 ;%% [MPa]  Water Potential at 50% loss conductivity
%%% Leaf
PsiL00_H =  -1.8; %% [MPa]  Water Potential at 2% loss conductivity
...
LDay_min_H =[11.3]; %% Minimum Day duration for leaf onset
...
LDay_cr_H = [11.3]; %%%  Threshold for senescence day light [h]
...
%%%%%%%%%%%%%%%%
LAI_H(1,:)=[3.23]; %
B_H(1,:,:)= [285 334 317 249 10 0 2.5 0]; %%
Rrootl_H(1,:)= [3288] ;
PHE_S_H(1,:)=[3];
dflo_H(1,:)=[0];
AgeL_H(1,:)=[455];
