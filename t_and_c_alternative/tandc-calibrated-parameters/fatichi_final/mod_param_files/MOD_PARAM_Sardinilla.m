...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Sardinilla C4 grass pasture  Paspalum dilatatum (C4), Rhynchospora
%nervosa (sedge, C3), Panicum dichotomiflorum (C4) and Sporobolus indicus (C4
%%% Height 0.09m in the pasture
%%% Pr = 2300   
%% GPP = 2345   LAI = 1.2 - 2.9 ;; Biomass 450 gC/m2 
%% LAI peak 3.0 - 5.4 
%%%% dry-matter product. 3-15 ton/ha/yr 
%%% GPP 2000-2300 Biomass AG  200 gC/m2 wet season ; close to 0 dry season 
%%% Tower height 3m at the pasture
%Clay, silt, sand [%] 58, 36, 6
%% 1-2 LU of grazing 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
dd_max_L= [1/15];%%%0.005  [1/d]  0.0250 -- 0.005-0.025 death maximum for drought
...
age_cr_L= [270]; %% [day] Critical Leaf Age
...
Mpar_L(1).jDay_cut=[1:30,200:365];
Mpar_L(1).LAI_cut=[-1.2]; %% Grazing %% 3/4 cattle/ ha  per 3-4 months
%Mpar_L(1).jDay_cut=[1:365];
%Mpar_L(1).LAI_cut=[-1.0]; %% -1.34 Grazing spread on the year  2 LU/ha 
%%%%%%
%%%%%%%%%%%% PRODUCTIVITY
Vmax_H = [0]; %
Vmax_L = [28]; %% 46
%%%%%%%%%%%%%%%%%%%%%%
%%%% Sim. GPP =2576 & LAI = 2.97 without grazing 
...
Ws_under(1)=1;
%%%%%%%%%%%%%% Volume [mm]
O(1,:)=    [  0.1780    0.1736    0.1167    0.0632    0.0632    0.0632    0.1038    0.1982    0.2345    0.2542    0.2665    0.2736    0.2785    0.2817    0.2871    0.2918    0.2956,...
    0.2987    0.3014    0.3037    0.3058    0.3077    0.3095    0.3112]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%Vmin= 0*dz;
%Vmax= (Osat-Ohy)*dz;
