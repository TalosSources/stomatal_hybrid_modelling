...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Pasoh Forest Reserve 1820 mm 25.3 degree C  
%%% Species Dipterocarpaceae, Leguminosae, Burseraceae 
%% Canopy height 35m,  emergent trees exceed 45m  LAI =6.52  
%Measurment height about 54 m
%% soils are Ultisols and Oxisols (Haplic Acrisol and Xanthic  Ferralsol in FAO classification)
%%% GPP 3250  ET 3.61 mm day
...
%%%%%%%%%%%%%%%%
LAI_H(1,:)=5.27; %
B_H(1,:,:)= [294 627 235 417 31 0 9 0]; %%
Rrootl_H(1,:)= [2323] ;
PHE_S_H(1,:)=3;
dflo_H(1,:)=86;
AgeL_H(1,:)=243;
