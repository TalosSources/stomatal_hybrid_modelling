...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%Nuuk_Fen (named Kobbefjord fen in literature) 
 %0.3 C and 1081 mm in Kobbefjord during the 2008–2018 period.
 %water saturated organic soils with an abundant snowmelt water supply


%  Eriophorum angustifolium and Scirpus caespitosus (Kobbefjord) (Bay 1998,
% Bay et al 2008) and an abundant moss layer characterized
% by the presence of Sanionia uncinata and
% Sphagnum lindbergii
...
LDay_min_L =[13.4]; %% Minimum Day duration for leaf onset
...
LDay_cr_L = [13.4]; %%%  Threshold for senescence day light [h]
...
Ts(1)=Ta(1)+2;
Tdamp(1)=0;
Tdp(1,:)= [  -3.5583   -3.5059   -3.4026   -3.2049   -2.9760   -2.7633   -2.5644   -2.3767   -2.1081   -1.7701   -1.4340   -1.0845,...
    -0.7091   -0.0386   -0.0009   -0.0058   -0.1058   -0.2761   -0.3894   -0.4830   -0.4779];
TdpI_H(1,:)=-3;
TdpI_L(1,:)=-3;
...
O(1,:)=  [  0.1529    0.1533    0.1542    0.1559    0.1581    0.1603    0.1626    0.1650    0.1687    0.1743    0.1814    0.1911 ,...
        0.2070    0.3576    0.5334    0.5050    0.2960    0.2472    0.2317    0.2225    0.2229];
Oice(1,:)=   [ 0.3833    0.3829    0.3820    0.3803    0.3781    0.3759    0.3736    0.3713    0.3675    0.3619    0.3549    0.3451 ,...
     0.3292    0.1786    0.0029    0.0312    0.2403    0.2891    0.3046    0.3137    0.3133  ]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%Vmin= 0*dz;
%Vmax= (Osat-Ohy)*dz;
