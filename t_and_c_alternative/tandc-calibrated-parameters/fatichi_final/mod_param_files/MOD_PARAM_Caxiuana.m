...
Oice = 0;
%%%%%%%%%%%%%%%%%%%
Zs=[0 10 50 100 200 300 400 600 800 1000 1250 1500 1750 2000 2500 3000 3500 4000 ]; %%% [ms+1]
Zdes=10;
Zinf=10;
Zbio = 250; 
...
%%%%%%%%%%%%%%%%%%%%%
%ZWT(1)= 1999; %% [mm]
O(1,:)=[  0.3075    0.3083    0.3082    0.3036    0.2965    0.2934    0.2916    0.2927    0.2943    0.2957    0.2950  ...
    0.2861    0.2370    0.2206    0.2372    0.2549    0.2629]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%Vmin= 0*dz;
%Vmax= (Osat-Ohy)*dz;
