...
Tlo_L = [6.0 6.0]; %% Mean Temperature for Leaf onset
...
LDay_min_L =[11.8 11.8]; %% Minimum Day duration for leaf onset
LtR_L = [0.40 0.40]; %%% Leaf to Root ratio maximum
...
LDay_cr_L = [10.1 10.1]; %%%  Threshold for senescence day light [h] [12.4 12.4]
...
%%%
LAI_L(1,:)=[1.0 1.0];
B_L(1,:,:)= [ 0 0 380 260 0 0 200 0; 0 0 440 310 0 0 200 0];
PHE_S_L(1,:)=[1 1 ];
dflo_L(1,:)=[0 0 ];
AgeL_L(1,:)=[25 25 ];
e_rel_L(1,:)=[1 1];
...
Ws_under(1,:)=1;
%%%%%%%%%%%%%% Volume [mm]
O(1,:)=  [   0.1515    0.1696    0.1784    0.1796    0.1370    0.0800    0.0437    0.0437    0.0437    0.0437    0.0440    0.1099    0.1657    0.1821    0.1970 ...
   0.2043    0.2085    0.2111    0.2131    0.2146    0.2167];
