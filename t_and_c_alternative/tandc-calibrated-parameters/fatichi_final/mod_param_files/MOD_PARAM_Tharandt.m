...
%%%%%%%%%%%%%%%%%%
%%%%%%% VEG. SPECIES  --- Picea abies  %% LAI 5.6 7.8 
...
rjv_H=[2.3]; %%% Scaling Jmax - Vmax  [umol electrons / umolCO2 ] 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%------
...
Tlo_H = [8.5]; %% Mean Temperature for Leaf onset
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LAI_H(1,:)=[4.5]; %
B_H(1,:,:)= [367 941 524 605 13 0 15 0]; %%
Rrootl_H(1,:)= [3800] ;
PHE_S_H(1,:)=[1];
dflo_H(1,:)=[0];
AgeL_H(1,:)=[869];
