%%%%% Closed conifer forest, minimal disturbance
%%% boreal--northern hardwood transitional forest consist of hemlock-spruce-fir, aspen-birch, and hemlock-hardwood mixtures.
%%% 41% red spruce 25 eastern hemlock 23% other conifers (balsam fir, white pine)
%%% 11% hardwoods (red maple paper birch)
%%% Tower Heightmore info: 	29m
%%% Height 20m tall 109 years median of canopy trees
%%% 6.2°C 1148 mm/yr 
%%% Carbon sequestr. 174 +- 46  gC/m2 yr 
%%% basal area 47.6 m2/ha
%%% GPP 1200-1450 gC/m2 yr 
%%% Upland soils are fine sandy loams,
%%%% LAI = 5.3  (4.7 5.8) 
%%% Soil depth 0.8 m 
%%% Litterfall 150 
...
Tlo_H = [5.25]; %% Mean Temperature for Leaf onset
...
%%%%%%%%%%%%%%%%%%%%%
LAI_H(1,:)=[3.7]; %
B_H(1,:,:)= [360 937 451 620 8 0 14 0]; %%
