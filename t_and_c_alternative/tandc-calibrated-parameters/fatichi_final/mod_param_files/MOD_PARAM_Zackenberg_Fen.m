...
%The fen area can be divided into
%a continuous fen, with flat areas dominated by Eriophorum
%scheuchzeri, Carex stans and Duponita psilosantha, and a
%hummocky fen dominated by E. triste, S. arctica and Andromeda latifolia 


%Eriophorum scheuchzeri and Dupontia
%psilosantha (Zackenberg) and an abundant moss layer characterized
%by the presence of Sanionia uncinata and
%Sphagnum lindbergii


%% ET 0.50 mm day-1  0.6-0.8 
%%% GPP =  252 /130 - 317 gC/m2 yr-1  (150-320) 
%At the wet fen a 3m tower
