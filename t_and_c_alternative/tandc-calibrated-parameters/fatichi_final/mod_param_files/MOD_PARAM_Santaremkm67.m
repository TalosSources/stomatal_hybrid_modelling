...
%%% HIGH VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_H = [0.019]; % 0.018 %% 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
%%%%%%%%%%%%%%%%
LAI_H(1,:)=[6.01]; %
B_H(1,:,:)= [304 621 243 405 33 0 16 0]; %%
Rrootl_H(1,:)= [2500] ;
PHE_S_H(1,:)=[3];
dflo_H(1,:)=[177];
AgeL_H(1,:)=[281];% 365
