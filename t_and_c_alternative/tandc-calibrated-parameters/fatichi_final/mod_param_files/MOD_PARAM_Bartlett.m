%%%% Red Maple, American Beech, Paper Birch, Eastern Hemlock 
%%Dominated by northern hardwoods (American beech, Fagus grandifolia; sugar maple, Acer saccharum; yellow birch, 
%Betula alleghaniensis; with some red maple, Acer rubrum and paper birch, Betula papyrifera). 
%Conifers (eastern hemlock, Tsuga canadensis; eastern white pine, Pinus strobus; red spruce, Picea rubens) are occasionally found intermixed 
%%Pr 1246 Ta 5.61 
%%% Shallow, well-drained spodosols Sand 74 Silt 23 Clay 4   Depth 0.3 - 0.75m 
% A 26.5/30  m high tower 
%%% Average canopy height in the vicinity of the tower is approximately 20–22 m
%%% Leaf area index in the vicinity of the tower is 3.6 as measured by seasonal litterfall collection, and 4.5 as measured by the optically based
%Stand age: 99 years (mean)
%Foliage prod. 150 gC/m2 
%%% Sla 0.016 
%%% Fine root 900 gC/m2  
%%% GPP 1052 
%%% Snow depth most years accumulates to depths of 1.5 to 2 m.
...
Oice = 0;
%%%%%%%%%%%%%
Zs= [0 10 20 50 100 150 200 300 400 500 600 800 ]; %% ms+1
Zdes = 10;
Zinf=  10;
Zbio = 250; 
...
%%% LOW VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_H = [0.021]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
LDay_min_H =[13.5]; %% Minimum Day duration for leaf onset 
...
LDay_cr_H = [11.9]; %%%  Threshold for senescence day light [h]
