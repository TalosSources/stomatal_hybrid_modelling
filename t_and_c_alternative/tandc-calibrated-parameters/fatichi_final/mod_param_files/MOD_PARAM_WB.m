...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% VEG. SPECIES 
%Oak (Quercus alba, Quercus prinus),  54%
%hickory (Carya ovata), 
%maple (Acer rubrum),  10% 
...
Oice = 0;
%%%%%%%%%%%%%%
Zs = [0 10 50 100 150 200 300 400 600 800 1000 1500]; %%% [ms+1]
%Zs= [0 100 200 300 400 600 800 1000 1200 1400 1600 2000];%% Ross et al.,
%Zs= [0 7.1 27.9 62.3 118.9 212.2 366.1 619.8 1038.0 1727.6 2864.6]; %% Oleson 2004 
Zdes = 10;
Zinf = 50; 
Zbio = 250; 
...
%%% HIGH VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_H = [0.026]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
LAI_min_H = [0.05];
Trr_H = [9.0]; %% Translocation rate [gC /m^2 d]
mjDay_H = [180]; %% Maximum Julian day for leaf onset
LDay_min_H =[11.6]; %% Minimum Day duration for leaf onset 
...
%%%%%%%%%%%%%%%%%%%%%
%ZWT(1)= 1999; %% [mm]
O(1,:)= [0.2437  0.2437   0.2642    0.2830    0.3068    0.3238    0.3374    0.3421    0.3252    0.3214  0.3438]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%Vmin= 0*dz;
%Vmax= (Osat-Ohy)*dz;
