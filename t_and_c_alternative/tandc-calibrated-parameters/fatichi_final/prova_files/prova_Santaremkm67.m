...
%%%%%%%%% METEO INPUT 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Santaremkm67'; 
%load('E:\SIM_DISC\DESKTOP_SF\Eco-Hydrology Patterns\Amazon_Data\Data_Santaremkm67_Run.mat')
load('E:\SIM_DISC\ARCHIVE\Università deposito II\Fluxnet Project\Other_Sites\Amazon\Data_Santaremkm67_Saleska_Run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%
Pre = Pre/100; N=Lwd;
