...
%%%%%%%%% METEO INPUT 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Siziwang_Grazed'; 
load('E:\SIM_DISC\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\FLX_CN-Sw2_FLUXNET2015_FULLSET_2010-2012_1-3\Data_Siziwang_Grazed_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%%%%%%%%%%%%%%%%%%%
