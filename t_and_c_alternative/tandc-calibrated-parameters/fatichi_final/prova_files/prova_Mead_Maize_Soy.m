...
%%%%%%%%% METEO INPUT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Mead_Maize_Soy';
load('C:\DD\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\FLX_US-Ne2_FLUXNET2015_SUBSET_2001-2013_1-3\Data_US_Ne2_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
IrD=Pr*0; %% Drip Irrigation 
%Pr = Pr + 0*Pr; %% Sprinkler Irrigation (already included in the time series of precipitation) 
%%%%%%%%%%%%%%%%%%%
x1=1;
x2=NN;
%%%%%%%%%%%%%%%%%%%%%%%%
