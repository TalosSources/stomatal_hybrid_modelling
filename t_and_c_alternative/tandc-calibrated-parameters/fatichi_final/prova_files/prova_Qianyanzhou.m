...
%%%%%%%%% METEO INPUT 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Qianyanzhou'; 
load('C:\DD\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\FLX_CN-Qia_FLUXNET2015_SUBSET_2003-2005_1-4\Data_Qianyanzhou_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%
N=Latm; 
