...
%%%%%%%%% METEO INPUT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Maui_Sugarcane';
load('E:\SIM_DISC\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\Maui_Sugarcane_Windy\Data_Maui_Sugarcane_Windy_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
IrD=Irr; IrD(1:2640)=0; %% Drip Irrigation 
%%%%%%%%%%%%%%%%%%%
x1=1;
x2=NN;
%%%%%%%%%%%%%%%%%%%%%%%%
