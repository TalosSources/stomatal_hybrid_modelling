...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Soroe'; 
load('E:\SIM_DISC\ARCHIVE\Università deposito II\Fluxnet Project\Other_Sites\DK_Sor\Data_Soroe_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%
x1=1; %% excluding 1996 because of the missing precipitation in the first 5 months
x2=NN;
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%5
Date=Date(x1:x2);
