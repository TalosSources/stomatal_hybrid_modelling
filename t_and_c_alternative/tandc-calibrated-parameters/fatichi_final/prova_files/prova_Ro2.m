...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Ro2'; 
load('C:\DD\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\FLX_IT-Ro2_FLUXNET2015_SUBSET_2002-2012_1-3\Data_Roccarespampani2_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%%%%%%%%%%%%%%%%%%%
...
SAD2=SAD2(x1:x2); SAB1=SAB1(x1:x2); Pre(x1:x2); 
