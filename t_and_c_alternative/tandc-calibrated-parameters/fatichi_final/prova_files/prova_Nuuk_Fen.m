...
%%%%%%%%% METEO INPUT 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Nuuk_Fen'; 
load('C:\DD\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\FLX_DK-NuF_FLUXNET2015_FULLSET_2008-2014_1-3\Data_Nuuk Fen_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%
