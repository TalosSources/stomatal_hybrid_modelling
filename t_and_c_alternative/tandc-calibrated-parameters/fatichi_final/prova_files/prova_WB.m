...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'WB';
load('E:\SIM_DISC\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\Walker_Branch_site\Data_WB_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%%%%%%%%%%%%%%%%%%%
...
Ds(Ds<0)=0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Ca=(363-355)/length(Date)*[1:length(Date)]+ 355; % [ppm]
