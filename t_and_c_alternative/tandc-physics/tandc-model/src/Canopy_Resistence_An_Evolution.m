...
function[rs_sun,rs_shd,Ci_sun,Ci_shd,An,Rdark,Lpho,SIF,DCi,...
    PAR_sun_canopy,PAR_shd_canopy,Vmax_sun_canopy,Vmax_shd_canopy,...
    Psi_L_sun_canopy,Psi_L_shd_canopy]=Canopy_Resistence_An_Evolution(PAR_sun,PAR_shd,LAI,...
    Kopt,Knit,Fsun,Fshd,Citm1_sun,Citm1_shd,...
    Ca,ra,rb,Ts,Ta,Pre,Ds,...
    Psi_L,Psi_sto_50,Psi_sto_99,...
    CT,Vmax,DS,Ha,FI,Oa,Do,a1,go,e_rel,e_relN,gmes,rjv,mSl,Sl,Opt_CR,flag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% INPUT
...
Psi_L_sun_canopy = Psi_L;
Psi_L_shd_canopy = Psi_L; 
...
Vmax_sun_canopy = Vmax_sun;
Vmax_shd_canopy = Vmax_shd; 
%%%%%%%%%%%%%%%%%%
...
PAR_sun_canopy = PAR_sun;
%disp(PAR_sun_canopy)
PAR_shd = PAR_shd/(LAI*Fshd);
PAR_shd_canopy = PAR_shd;
%disp(PAR_shd_canopy)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% SUNLIT FRACTION
if Fsun > 0
    ...
    [Ci_sun]=fzero(@CO2_Concentration,Citm1_sun,Opt_CR,PAR_sun,Ca,ra,rb_sun,Ts,Pre,Ds,...
        Psi_L,Psi_sto_50,Psi_sto_99,CT,Vmax_sun,DS,Ha,FI,Oa,Do,a1,go_sun,gmes_sun,rjv,flag);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [CiF_sun,An_sun,rc_sun,Rdark_sun,SIF_sun]= photosynthesis_biochemical(Ci_sun,PAR_sun,Ca,ra,rb_sun,Ts,Pre,Ds,...
        Psi_L,Psi_sto_50,Psi_sto_99,...
        CT,Vmax_sun,DS,Ha,FI,Oa,Do,a1,go_sun,gmes_sun,rjv,flag);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
else
...
if Fshd > 0
    ...
    [Ci_shd]=fzero(@CO2_Concentration,Citm1_shd,Opt_CR,PAR_shd,Ca,ra,rb_shd,Ts,Pre,Ds,...
        Psi_L,Psi_sto_50,Psi_sto_99,CT,Vmax_shd,DS,Ha,FI,Oa,Do,a1,go_shd,gmes_shd,rjv,"shd");
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%
    [CiF_shd,An_shd,rc_shd,Rdark_shd,SIF_shd,Psi_L_shd_canopy]= photosynthesis_biochemical(Ci_shd,PAR_shd,Ca,ra,rb_shd,Ts,Pre,Ds,...
        Psi_L,Psi_sto_50,Psi_sto_99,...
        CT,Vmax_shd,DS,Ha,FI,Oa,Do,a1,go_shd,gmes_shd,rjv,"shd");
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
else
