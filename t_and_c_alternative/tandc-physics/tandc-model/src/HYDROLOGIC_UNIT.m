...
function[V,Vice,O,Oice,ZWT,OF,OS,OH,OL,Psi_s_H,Psi_s_L,Rd,Qi_out,WTR,...
    ...
    snow_alb,tau_sno,e_sno,Ws_under,dQVEG,HV,QEV,TsV,EK,POT,...
    ran_L,ran_H,...
    PAR_sun_L_hydro,PAR_shd_L_hydro,PAR_sun_H_hydro,PAR_shd_H_hydro,...
    Vmax_sun_L_hydro,Vmax_shd_L_hydro,Vmax_sun_H_hydro,Vmax_shd_H_hydro,...
    Psi_sun_L_hydro,Psi_shd_L_hydro,Psi_sun_H_hydro,Psi_shd_H_hydro]=HYDROLOGIC_UNIT(Vtm1,Oicetm1,aR,Zs,...
...
[Ts,Pr_sno,Pr_liq,Ws_under,Csno,Cice,Cfol_H,Cfol_L,CLitter,NDVI,rb_H,rb_L,rs_sunH,rs_sunL,rs_shdH,rs_shdL,r_litter,...
    ...
    PAR_sun_L_hydro,PAR_shd_L_hydro,PAR_sun_H_hydro,PAR_shd_H_hydro,...
    Vmax_sun_L_hydro,Vmax_shd_L_hydro,Vmax_sun_H_hydro,Vmax_shd_H_hydro,...
    Psi_sun_L_hydro,Psi_shd_L_hydro,Psi_sun_H_hydro,Psi_shd_H_hydro]=SVAT_UNIT(Tstm0,Pr,Ta,Ds,Ws,zatm,Tstm1,dt,ea,Latm,N,Pre,...
