...
%%%%%
ZBIOG = 0.25; %%[m]
rsd =1428; %% density dry soil [kg/m^3]
Pcla = 0.30; Psan= 0.45;
PH=5.7;  %% Soil - Ph
Zs=2.0; %% [m]
Se_fc = 0.7379;

Lat=  42.3903; Lon= 11.9209;
Ts= 15.50;
Ta= 15.46;
%%%%
Psi_s =  -0.0360; %%[MPa]
...
T =1.054; %%[mm/day]
VT= 7.53 ;%% [mm]
Broot = 360; %% [gC-Root/m2]
RexmyI =[0.0155 0.0618 0]; %% [gC m2 /day]
Ccrown=1;

%%%% INPUT  %% [gC/m^2 day]
%%%% Carbon Inputs
IS(1)= 0.630200208179729; %IS.C_met_sur_lit =  [gC/m^2 day]
IS(2)= 0.036992314595971;%IS.C_str_sur_lit_lig =
IS(3)= 0.223053116619031;%IS.C_str_sur_lit_nlig =
%%%%
IS(4)= 0.104057099756315;%IS.C_wod_sur_lit_lig =
IS(5)=   0.312171299268946;%IS.C_wod_sur_lit_nlig =
%%%%
IS(6)= 0.204211393173303;%IS.C_met_ssr_lit =
IS(7)= 0.043443332015098 ;%IS.C_str_ssr_lit_lig =
IS(8)= 0.171626372433381 ;%IS.C_str_ssr_lit_nlig =
%%%
IS(9)= 0.061841905743051;  %IS.C_myc
%%%% Nitrogen Inputs
IS(10)=  0.015692478025465; %IS.N_sur_lit =  %  [gN/m^2 day]
IS(11)=  0.002155468494952;%IS.N_wod_lit =
IS(12)= 0.007086391374703;%IS.N_ssr_lit =   % [gN/m^2 day]
%%%% Phosoporus Inputs
IS(13)=0.001120891287533; %IS.P_sur_lit =  % [gP/m^2 day]
IS(14)= 0.000153962035354;%IS.P_wod_lit = ;
IS(15)=   0.000506170812479 ;%IS.P_ssr_lit = ;   % [gP/m^2 day]
%%%% Potassium Inputs
IS(16)= 0.007846239012733;%IS.K_sur_lit =  ; % [gK/m^2 day]
IS(17)= 0.001077734247476 ;%IS.K_wod_lit = ;
IS(18)= 0.001114601129156;%IS.K_ssr_lit = ;   % [gK/m^2 day]
