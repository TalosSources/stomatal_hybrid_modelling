...
Slo_pot=zeros(1,ms); %% [fraction dy/dx] Slope of the hydraulic head for each soil layer 
...
%%%%%%%%%%%%%%%%%%
%%%%%%% VEG. SPECIES  --- Low Grasses -- High Deciduous      
...
%%%%%%%%%%%%
rsd=rsd*ones(1,ms); % Normal density dry soil 
lan_dry=lan_dry*ones(1,ms); 
lan_s =lan_s*ones(1,ms); 
cv_s = cv_s*ones(1,ms); %Volumetric heat capacity soil solid [J/m^3 K]
%%%%%%%%%%%%%%%
%%%
