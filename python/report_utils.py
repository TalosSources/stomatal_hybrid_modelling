...
def load_train_test_data(config_name):
    ...
    train_data, test_data = train_test_split(all_data, test_size=config.train.test_split, random_state=config.train.random_state, shuffle=True)
...
def generate_Q_LE_slice_plots(rs_model):
    ...
    with torch.no_grad():
        ...
        hot_wet_point = (
            (
                {
                    'sun_H': {'Cc': t([289.3110]), 'IPAR': t([90.7115]), 'Csl': t([376.3200]), 'ra': t([8.8555]), 'rb': t([51.0891]), 'Ts': t([28.1250]), 'Pre': t([1007.]), 'Ds': t([967.4290]), 'Psi_L': t([-0.0663]), 'Rn': t([475.5663]), 'QG': t([127.6617]), 'Vmax': t([37.7132]), 'Psi_sto_50': t([-1.7000]), 'Psi_sto_00': t([-0.9000]), 'CT': t([3.]), 'Ha': t([72.]), 'FI': t([0.0810]), 'Oa': t([210000.]), 'Do': t([1000.]), 'a1': t([6.]), 'go': t([0.0100]), 'gmes': t([np.inf]), 'rjv': t([2.2000]), 'DS': t([0.6490])}, 
                    'shd_H': {'Cc': t([298.4520]), 'IPAR': t([35.0558]), 'Csl': t([376.3200]), 'ra': t([8.8555]), 'rb': t([51.0891]), 'Ts': t([28.1250]), 'Pre': t([1007.]), 'Ds': t([967.4290]), 'Psi_L': t([-0.0663]), 'Rn': t([475.5663]), 'QG': t([127.6617]), 'Vmax': t([23.1776]), 'Psi_sto_50': t([-1.7000]), 'Psi_sto_00': t([-0.9000]), 'CT': t([3.]), 'Ha': t([72.]), 'FI': t([0.0810]), 'Oa': t([210000.]), 'Do': t([1000.]), 'a1': t([6.]), 'go': t([0.0100]), 'gmes': t([np.inf]), 'rjv': t([2.2000]), 'DS': t([0.6490])}
                }, 
                {'EIn_H': t([0.1231]), 'EIn_L': t([0.]), 'EG': t([0.0432]), 'ELitter': t([0.]), 'ESN': t([0.]), 'ESN_In': t([0.]), 'EWAT': t([0.]), 'EICE': t([0.]), 'EIn_urb': t([0.]), 'EIn_rock': t([0.])}
            ), 
            t(338.4500)
        )

        # Cold, Humid (CH-Dav)
        cold_wet_point = (({'sun_H': {'Cc': t([319.2088]), 'IPAR': t([40.6829]), 'Csl': t([362.6200]), 'ra': t([61.0868]), 'rb': t([24.1148]), 'Ts': t([-4.3020]), 'Pre': t([829.9150]), 'Ds': t([92.6856]), 'Psi_L': t([-0.0258]), 'Rn': t([9.2711]), 'QG': t([-0.6741]), 'Vmax': t([35.1236]), 'Psi_sto_50': t([-2.5000]), 'Psi_sto_00': t([-0.5000]), 'CT': t([3.]), 'Ha': t([72.]), 'FI': t([0.0810]), 'Oa': t([210000.]), 'Do': t([800.]), 'a1': t([5.]), 'go': t([0.0100]), 'gmes': t([np.inf]), 'rjv': t([2.1000]), 'DS': t([0.6490])}, 
                            'shd_H': {'Cc': t([326.8221]), 'IPAR': t([16.2409]), 'Csl': t([362.6200]), 'ra': t([61.0868]), 'rb': t([24.1148]), 'Ts': t([-4.3020]), 'Pre': t([829.9150]), 'Ds': t([92.6856]), 'Psi_L': t([-0.0258]), 'Rn': t([9.2711]), 'QG': t([-0.6741]), 'Vmax': t([23.2060]), 'Psi_sto_50': t([-2.5000]), 'Psi_sto_00': t([-0.5000]), 'CT': t([3.]), 'Ha': t([72.]), 'FI': t([0.0810]), 'Oa': t([210000.]), 'Do': t([800.]), 'a1': t([5.]), 'go': t([0.0100]), 'gmes': t([np.inf]), 'rjv': t([2.1000]), 'DS': t([0.6490])}}, 
        {'EIn_H': t([0.]), 'EIn_L': t([0.]), 'EG': t([0.]), 'ELitter': t([0.]), 'ESN': t([0.0083]), 'ESN_In': t([0.0025]), 'EWAT': t([0.]), 'EICE': t([0.]), 'EIn_urb': t([0.]), 'EIn_rock': t([0.])}), t(25.3235))

        # Hot, Dry (AU-STP)
        hot_dry_point = (({ 'sun_L': {'Cc': t([223.7393]), 'IPAR': t([247.4754]), 'Csl': t([386.0600]), 'ra': t([107.2802]), 'rb': t([23.3581]), 'Ts': t([30.8950]), 'Pre': t([974.6000]), 'Ds': t([1786.9075]), 'Psi_L': t([-0.3937]), 'Rn': t([596.9096]), 'QG': t([157.3113]), 'Vmax': t([30.4333]), 'Psi_sto_50': t([-2.]), 'Psi_sto_00': t([-0.3000]), 'CT': t([4.]), 'Ha': t([72.]), 'FI': t([0.0400]), 'Oa': t([210000.]), 'Do': t([1500.]), 'a1': t([6.]), 'go': t([0.0100]), 'gmes': t([np.inf]), 'rjv': t([1.9000]), 'DS': t([0.6490])}, 
                            'shd_L': {'Cc': t([237.9602]), 'IPAR': t([174.7201]), 'Csl': t([386.0600]), 'ra': t([107.2802]), 'rb': t([23.3581]), 'Ts': t([30.8950]), 'Pre': t([974.6000]), 'Ds': t([1786.9075]), 'Psi_L': t([-0.3937]), 'Rn': t([596.9096]), 'QG': t([157.3113]), 'Vmax': t([29.8925]), 'Psi_sto_50': t([-2.]), 'Psi_sto_00': t([-0.3000]), 'CT': t([4.]), 'Ha': t([72.]), 'FI': t([0.0400]), 'Oa': t([210000.]), 'Do': t([1500.]), 'a1': t([6.]), 'go': t([0.0100]), 'gmes': t([np.inf]), 'rjv': t([1.9000]), 'DS': t([0.6490])}}, 
        {'EIn_H': t([0.]), 'EIn_L': t([0.]), 'EG': t([0.0631]), 'ELitter': t([0.]), 'ESN': t([0.]), 'ESN_In': t([0.]), 'EWAT': t([0.]), 'EICE': t([0.]), 'EIn_urb': t([0.]), 'EIn_rock': t([0.])}), t(293.))

        x_0s = [
            (torch.tensor([1007. , 967.4290, 28.1250]), hot_wet_point),
        ...
        empirical_wrapper = lambda x, datapoint : wrapper(empirical_pipeline, x, datapoint)
...
def generate_multiple_model_plots(rs_models):
    ...
    # for each of the input variables, make a slice plot
    with torch.no_grad():
        path = os.path.join('figures', 'multiple_models_slices', f'combined_multimodel_slices.svg')
        plot.plot_univariate_slices_subplots(wrappers, x_0s, x_0_labels, idx_and_ranges, 100, 
                                                 labels, res_label='rs [s/m]', path=path, show=True)
...
def generate_site_experiment_plots(hot_rs, cold_rs, dry_rs, wet_rs, balanced_rs, test_ordered_data, seed=24):
    ...
    dry_data = np.array(dry_data, dtype=object)[gen.choice(len(dry_data), trunc, replace=False,)]
    wet_data = np.array(wet_data, dtype=object)[gen.choice(len(wet_data), trunc, replace=False,)]
    hot_data = np.array(hot_data, dtype=object)[gen.choice(len(hot_data), trunc, replace=False,)]
    cold_data = np.array(cold_data, dtype=object)[gen.choice(len(cold_data), trunc, replace=False,)]
    ...
    path = os.path.join('figures', 'site_experiment_scatters', f'cold_on_hot_scatter.svg')
    with torch.no_grad():
        plot.fit_plot(models_list, cold_data, labels, path, unit=f'Q_LE [W/m²]', pointsize=6, alpha=0.2, colors=colors, show=True)

    # Then, plot the hot, cold and balanced pipeline with hot data
    path = os.path.join('figures', 'site_experiment_scatters', f'hot_on_cold_scatter.svg')
    with torch.no_grad():
        plot.fit_plot(models_list, hot_data, labels, path, unit=f'Q_LE [W/m²]', pointsize=6, alpha=0.2, colors=colors, show=True)
    ...
    path = os.path.join('figures', 'site_experiment_scatters', f'wet_on_dry_scatter.svg')
    with torch.no_grad():
        plot.fit_plot(models_list, wet_data, labels, path, unit=f'Q_LE [W/m²]', pointsize=6, alpha=0.2, colors=colors, show=True)

    # Then, plot the dry, wet and balanced pipeline with dry data
    path = os.path.join('figures', 'site_experiment_scatters', f'dry_on_wet_scatter.svg')
    with torch.no_grad():
        plot.fit_plot(models_list, dry_data, labels, path, unit=f'Q_LE [W/m²]', pointsize=6, alpha=0.2, colors=colors, show=True)
...
def coeff_determination_ordered(test_datas, rs_model, seed=24):
    ...
    for site_data, site_name in test_datas:
        ...
        # Take random sample
        test_indices = gen.choice(len(site_data), 2000, replace=False,)
        site_data = np.array(site_data, dtype=object)[test_indices]

        our_coeff = eval.coefficient_of_determination(pipeline, site_data)
        empirical_coeff = eval.coefficient_of_determination(empirical_pipeline, site_data)
    ...
    empirical_combined_coeff = eval.coefficient_of_determination(empirical_pipeline, combined)
