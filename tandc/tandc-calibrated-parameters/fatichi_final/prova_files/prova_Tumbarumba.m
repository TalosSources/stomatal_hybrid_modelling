...
%%%%%%%%% METEO INPUT 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Tumbarumba'; 
load('C:\DD\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\FLX_AU-Tum_FLUXNET2015_FULLSET_2001-2014_2-3\Data_Tumbarumba_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
N=Latm; 
%%%%%%%%%%%%%%%%%%%
