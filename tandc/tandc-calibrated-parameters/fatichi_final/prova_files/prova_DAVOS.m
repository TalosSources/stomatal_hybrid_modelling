...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'DAVOS'; 
%load('E:\SIM_DISC\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet_Swiss\SWISS_flux\Data_Davos_run.mat')
load('E:\SIM_DISC\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet - Data\FLX_CH-Dav_FLUXNET2015_SUBSET_1997-2014_1-3\Data_Davos_New_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%Pr=Pr_point; 
