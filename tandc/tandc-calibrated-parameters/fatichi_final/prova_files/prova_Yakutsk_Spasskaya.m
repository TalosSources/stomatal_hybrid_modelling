...
load('C:\DD\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet - Data\FLX_RU-SkP_FLUXNET2015_SUBSET_2012-2014_1-4\Data_Yakutsk_Spasskaya_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%%%%%%%%%%%%%%%%%%%
