...
load('C:\DD\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet - Data\FLX_US-Tw1_FLUXNET2015_SUBSET_2012-2014_1-4\Data_Twitchell_Wetland_West_Pond_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
