...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Konza';
load('E:\SIM_DISC\DESKTOP_SF\BILANCIO IDROLOGICO\Experimental Watershed\Konza_Praire_Data\Data_Konza_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%
x1=1;
...
%Ca=(396-344)/length(Date)*[1:length(Date)]+ 344; % [ppm]
