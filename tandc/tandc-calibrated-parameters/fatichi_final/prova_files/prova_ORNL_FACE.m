...
%%%%%%%%% METEO INPUT 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'ORNL_FACE'; 
load('E:\SIM_DISC\DESKTOP_SF\BILANCIO IDROLOGICO\Experimental Watershed\FACE Model-Data Synthesis\Phase1_met_data\ORNL\Data_ORNL_FACE_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Lwd; 
%%%%%%%%%%%%%%%%%%%
