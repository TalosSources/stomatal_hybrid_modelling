...
%load('E:\SIM_DISC\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet_Swiss\SWISS_flux\Data_Fruebuel_Run_2.mat')
load('E:\SIM_DISC\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet - Data\FLX_CH-Fru_FLUXNET2015_SUBSET_2005-2014_2-3\Data_Fruebuel_New_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%Pr=Pr_point; 
