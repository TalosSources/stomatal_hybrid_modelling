...
%%%%%%%%% METEO INPUT 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Zackenberg_Heath'; 
load('C:\DD\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\FLX_DK-ZaH_FLUXNET2015_FULLSET_2000-2014_2-3\Data_Zackenberg_Heath_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
IrD=Pr*0; IrD(Ta>5.9)=0.1; %% Drip Irrigation to compensate for runoff removing water 
%%%%%%%%
