...
load('E:\SIM_DISC\\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet - Data\Duke\Duke_loblolly_data_filled_AMERIFLUX.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DeltaGMT=-5;
Lon=-79.0942;
...
%Ca1 = Ca + 200 + Date'*0; 
%Ca( (Rsw>10) & (Ta > 5))=Ca1((Rsw>10) & (Ta > 5));  
