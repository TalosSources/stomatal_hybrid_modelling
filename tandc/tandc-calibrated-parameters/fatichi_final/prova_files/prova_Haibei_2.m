...
%%%%%%%%% METEO INPUT 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'Haibei_2'; 
load('C:\DD\ARCHIVE\Università deposito II\Fluxnet Project\Fluxnet - Data\FLX_CN-Ha2_FLUXNET2015_SUBSET_2003-2005_1-3\Data_Haibei_Shrubland_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%%%%%%%%%%%%%%%%%%%
