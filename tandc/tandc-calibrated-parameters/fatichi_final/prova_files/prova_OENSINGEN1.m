...
%load('E:\SIM_DISC\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet_Swiss\SWISS_flux\Data_Oensingen1_run.mat')
load('E:\SIM_DISC\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet - Data\FLX_CH-Oe1_FLUXNET2015_SUBSET_2002-2008_2-3\Data_Oensingen1_New_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%%%%%%%%%%%%%%%%%%%
