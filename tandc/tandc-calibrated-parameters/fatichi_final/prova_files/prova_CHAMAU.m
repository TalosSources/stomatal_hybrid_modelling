...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
id_location = 'CHAMAU';
%load('E:\SIM_DISC\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet_Swiss\SWISS_flux\Data_Chamau_Run_2.mat')
load('E:\SIM_DISC\ARCHIVE\Universit� deposito II\Fluxnet Project\Fluxnet - Data\FLX_CH-Cha_FLUXNET2015_SUBSET_2005-2014_2-3\Data_Chamau_New_run.mat')
NN=length(Date);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N=Latm; 
%%%%%%%%%%%%%%%%%%%
