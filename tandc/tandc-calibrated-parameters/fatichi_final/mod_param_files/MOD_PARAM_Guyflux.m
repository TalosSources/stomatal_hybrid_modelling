...
%%% Tropical forest 55-m high  Mean tree height is 35?m, with emergent trees exceeding 40?m
%Clay and sand content in the 1?m deep horizon are 43.2% and 47.8% on top of the hills and 25.8% and 64.6% on the sandy plateau
%%% LAI =5.9 
...
Oice = 0;
%%%%%%%%%%%%%%%%%%%
Zs=[0 10 50 100 200 300 400 600 800 1000 1250 1500 1750 2000 2500 3000 3500 4000 4500 5000 5500 6000 6500 7000 7500 8000 ]; %%% [ms+1]
Zdes=10;
Zinf=10;
Zbio = 250; 
...
Do_H=1000; %%[Pa]
a1_H=6; % influences transpiration - latent heat
...
%LAI_max_H= [2.0 10.0];
aSE_H=3; %%% Plant Type -- 1 Seasonal Plant --  0 Evergreen  -- 2 Grass species -- 
...
%%%%%%%%%%%%%%%%
LAI_H(1,:)=5.06; %
B_H(1,:,:)= [304 637 244 402 34 0 10 0]; %%
Rrootl_H(1,:)= [2270] ;
PHE_S_H(1,:)=3;
dflo_H(1,:)=223;
AgeL_H(1,:)=275;
...
%%%%
PARI_H(1,:,:)= [93.7943    97.1960   -3.1136];
NBLI_H(1,:)= 0.4084;
PARI_L(1,:,:)=[0 0 0]; 
NBLI_L(1,:)=0;
%%%%
