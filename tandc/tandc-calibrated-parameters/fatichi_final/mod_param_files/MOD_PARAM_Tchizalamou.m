...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Tchizalamou - Grassland -  Grassland Loudetia sp., Ctenium newtonii - 100% C4 
%Loudetia simplex, Loudetia arundinacea, or Andropogon shirensis
%%%%% unprotected
%%% Tower height 3.8 changing  
%%% Peak LAI 2.0 -- mean maximum height of 1.5 m
%above-ground biomass, that reached about 3.8Mg ha-1 of dry matter 190 [gC/m2] at the end of the rainy season
%Sand content > 85%  
%%% fires every year, between mid-June and mid-July
%No agriculture or cattle grazing are conducted in the grasslands
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Oice = 0;
%%%%%%%%%%%%%
Zs = [0 10 50 100 150 200 300 400 600 800 1000 1250 1500 ]; %%% [ms+1]
Zdes = 10;
Zinf=  10;
Zbio = 250;
...
Ha_L =[65]; %% [kJ / mol K]  entropy factor - Plant Dependent
gmes_L=[Inf];
rjv_L= [1.9];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Psi_sto_00_H =  -0.3; %% [MPa]  Water Potential at 2% loss conductivity
%%% Leaf
...
%%------------------------
%
Psi_sto_00_L = -0.3;%  %% [MPa]  Water Potential at PLCs loss conductivity
Psi_sto_50_L = -1.4;%  %% [MPa]  Water Potential at 50% loss conductivity
%%% Leaf
PsiL00_L =  -0.6; %% [MPa]  Water Potential at PLCs% loss conductivity
PsiL50_L =  -2.8 ;%%[MPa]  Water Potential at 50% loss conductivity
...
%%%%
Mpar_L(1).Date_fire = [Date(1)+210:365.25:Date(end)];
Mpar_L(1).fire_eff = 1;
...
Vmax_L = [32]; %% 46
%%%%%%%%%%%%%%%%%%%%%%
%%%% Sim. GPP =2728 & LAI = 3.22 without grazing 
...
Ws_under(1)=1;
%%%%%%%%%%%%%% Volume [mm]
O(1,:)=  [     0.1200    0.1231    0.1267    0.1508    0.1647    0.1774    0.1863    0.1948    0.2012    0.2057    0.2097    0.2126  ]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%Vmin= 0*dz;
%Vmax= (Osat-Ohy)*dz;
