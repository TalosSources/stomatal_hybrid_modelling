...
%% Eucalyptos ;; Sorghum & ...
% The flux tower site is classified as open forest savanna site. The overstory is co-dominated by tree species E. tetrodonta, 
%E. dichromophloia, C. terminalis, Sorghum intrans, S. plumosum, Themeda triandra and Chrysopogon fallax
%
% Clay = 50 Silt # Sand 25 - K = 3 mm/h (A)
% Clay = 55 Silt # Sand 20 - K = 2 mm/h (B)
% Tree height: 12.3
% GPP = 1230 gC/m2 
% LAI= 0.6 (1.2)
% Ta = 26.8  Pr = 850 (836-1063) ET = 805 (+/- 361)
%%% tower height 15
% Soil moisture data: ...
% Tree cover = 44%
% Open-forest/woodland savanna: typically 25% or 15-50% [Scholes & Archer,1997, Ann Rev Ecol Syst] (0.2% at Stuart plain)
%%
...
%%% HIGH VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_H = [0.009 0.009]; % [0.009 0.009]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
%%%%%%%%%%%%%%%%
LAI_H(1,:)=[1.53 0.0]; %
B_H(1,:,:)= [203 103 324 97 8 0 36 0 ;0 0 0 0 0 0 0 0]; %%
Rrootl_H(1,:)= [2334 0] ;
PHE_S_H(1,:)=[3 1];
dflo_H(1,:)=[117 0];
AgeL_H(1,:)=[191 0];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
LAI_L(1,:)=[0.0 0.18];
B_L(1,:,:)= [0 0 0 0 0 0 0 0 ; 5 0 42 138 1 0 1 0 ];
Rrootl_L(1,:)= [0 945] ;
PHE_S_L(1,:)=[0 2];
dflo_L(1,:)=[0 19];
AgeL_L(1,:)=[0 13];
...
%%%%
PARI_H(1,:,:)= [130.88 130.83  1.13 ; 0 0 0];
NBLI_H(1,:)=   [1.0835 0];
...
%%%%%%%%%%%%%% Volume [mm]
%%%%%%%%%%%%%%%%%%%%%
O(1,:)= [ 0.3723    0.3713    0.3692    0.3669    0.3645    0.3607    0.3554    0.3499    0.3444    0.3394    0.3348    0.3308    0.3273 ...
 0.3240    0.3189    0.3112    0.2934    0.2665    0.2498    0.2491    0.2527    0.2585    0.2651    0.2718    0.2767    0.2794  0.2811]; 
