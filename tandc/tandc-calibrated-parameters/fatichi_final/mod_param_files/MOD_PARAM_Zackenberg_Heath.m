...
%The tundra heath site is characterized by Cassiope tetragona,
%D. integrifolia, Vaccinium uliginosum and patches of mosses, E. scheuchzeri and S. arctica 

%% ET (0.5 -1 mm/day during growing season)  40-80 mm
%active layer thickness at the end of the summer reaches between 0.4 and 0.8m
%At the dry heath a 3m tower
%maximum leaf area index (LAI) generally ranges 0.2–0.3.
%% SND peak 10-120 cm 
%%% GPP 90 gC m-2 yr-1  NPP 78 gC m-2 yr-1
%%% GPP = 156 - 116 ??? 
...
LDay_min_L =[15.0]; %% Minimum Day duration for leaf onset
...
LDay_cr_L = [15.0]; %%%  Threshold for senescence day light [h]
...
Ts(1)=Ta(1)+2;
Tdamp(1)=0;
Tdp(1,:)= [  -12.4345  -12.3902  -12.2835  -12.0327  -11.7320  -11.4236  -11.1180  -10.8162  -10.3644   -9.7677   -9.3047   -8.9323   -8.5724   -8.0530   -7.3413   -6.6498   -5.7511,...
    -4.8489   -4.1762   -3.4662   -3.1482];
TdpI_H(1,:)=-12;
TdpI_L(1,:)=-12;
...
O(1,:)=  [  0.1308    0.1308    0.1308    0.1308    0.1308    0.1308    0.1308    0.1308    0.1308    0.1308    0.1308    0.1308    0.1308    0.1312    0.1335    0.1360    0.1397 ,...
        0.1443    0.1484    0.1537    0.1566];
Oice(1,:)=   [   0.4055    0.4055    0.0931    0.1815    0.1236    0.1191    0.1142    0.1172    0.0994    0.1002 ,...
    0.4053    0.4055    0.4055    0.4051    0.4028    0.4003    0.3965 0.3920    0.3879    0.3824    0.3824  ]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%Vmin= 0*dz;
%Vmax= (Osat-Ohy)*dz;
