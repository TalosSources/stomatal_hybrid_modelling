...
zatm = 21.65; %% Reference Height
%%%%%%%%%%%%%%%%%%
%%%%%%% VEG. SPECIES  --- 
%%%% LAND COVER PARTITION
%The primary forest type of the study site is a mixed conifer forest, consisting of Douglas fir, white fir, blue spruce, southwestern white pine, limber pine, 
%and ponderosa pine along with scattered aspens and very little understory (Muldavin and Tonne, 2003). Site characteristics for the trees at this site are 783 
%(259, one standard error) stems ha-1, with a mean diameter at breast height (dbh) of 26.9(2.5) cm, mean height of 19.6(0.9) m, and LAI of 3.43 (0.50) m2 m-2 (McDowell et al. 2008)
...
Ha_H =[90]; %% [kJ / mol K]  entropy factor - Plant Dependent 
...
%%%%%%%%%%%%%%%%%%%%%
LAI_H(1,:)=[3.4]; %
B_H(1,:,:)= [195 470 285 322 5 0 24 0]; %%
Rrootl_H(1,:)= [4200] ;
PHE_S_H(1,:)=[1];
dflo_H(1,:)=[0];
AgeL_H(1,:)=[950];
...
Ws_under(1)=1; 
%%%%%%%%%%%%%% Volume [mm]
O(1,:)= [  0.2091    0.2086    0.2074    0.2049    0.2014    0.1980    0.1935    0.1876    0.1816    0.1770    0.1779    0.1835    0.1946];
%%%%%%%%%%%%%%%%%%%
V(1,:) = (O(1,:) -Ohy).*dz;
%%%%%%%%%%%%%%%%%
cd(cur_dir)
