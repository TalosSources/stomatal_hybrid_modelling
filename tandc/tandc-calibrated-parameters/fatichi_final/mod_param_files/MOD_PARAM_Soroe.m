...
% according to Granier etal2007 LAI 4.8, GPP 1400, carbon uptake starting
% in DOY 110 almost 0 in 220
% GPP 1600 LAI 5, Peltoniemi et al 2012
% Fagus dec. forest 
 
% Pilegaard et al 2011 mean Temp 8.5, annual precip 584mm.
% Lindroth et al 2008 mean Temp 8.3, annual precip 730mm.
% Data 1996-2006  8.4, 1997-2006 668mm


%%% LAI 4.65-5  GPP mean 1612 ( 1456-1785)  Live roots 450 

%The soil is a mollisol with a 10–40 cm deep surface organic layer.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Oice = 0;
%%%%%%%%%%%%%
Zs = [ 0 10 20 50 100 150 200 300 400 500 600 800 1000 1200 1400 1700 2000]; %%% [ms+1]
Zdes = 10;
Zinf=  10;
Zbio = 250; 
...
KnitH=0.15; %%% Canopy Nitrogen Decay
KnitL=0.5; 
...
%%% HIGH VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_H = [0.018]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
r_H =  [0.035];  %% [0.066 -0.011] respiration rate at 10° [gC/gN d ]
...
Tlo_H = [2.0]; %% Mean Temperature for Leaf onset
Tls_H = [NaN]; %% Mean Temperature for Leaf Shed
PAR_th_H= [NaN]; 
dmg_H= [35]; %%% Tree 30 Grasses Day of Max Growth
LAI_min_H = [0.01];
Trr_H = [5.0]; %% Translocation rate [gC /m^2 d]
mjDay_H = [250]; %% Maximum Julian day for leaf onset
LDay_min_H =[12.3]; %% Minimum Day duration for leaf onset 
...
LDay_cr_L = [10.2]; %%%  Threshold for senescence day light [h]
...
Ws_under(1)=1; 
%%%%%%%%%%%%%% Volume [mm]
O(1,:)=[0.2391 0.2390 0.2387 0.2374 0.2353 0.233 0.2297 0.227 0.2267 0.231 0.2372 0.2427 0.2462 0.248 0.2492 0.2497]; 
%%%%%%%%%%%%%%%%%%%
V(1,:) = (O(1,:) -Ohy).*dz;
%%%%%%%%%%%%%%%%%
cd(cur_dir)
