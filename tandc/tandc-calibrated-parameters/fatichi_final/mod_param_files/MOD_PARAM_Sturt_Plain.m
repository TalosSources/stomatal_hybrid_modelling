...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% C4 Grassland Astrebla Sp. 

%%%% Sturt Plain GPP= 480 gC/m2  LAI = 0.39 -  0.5 Ta = 26 C  Pr 535-735 mm/yr  ET =549 
%%% Loam soil (20 clay 40 Sand ) 
%% Tower height 5 m 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%
...
Oice = 0;
%%%%%%%%%%%%%
Zs = [ 0 10 50 100 150 200 300 400 500 600 700 800 900 1000 1100 1300 1500 2000 2500 3000 3500 4000 5000 6000 8000 10000]; %%% [ms+1]
Zdes = 10;
Zinf=  10; 
Zbio = 250; 
...
%%% Leaf
PsiL00_H =  -1.4 ;%%[MPa]  Water Potential at 50% loss conductivity
PsiL50_H =  -5.5; %% [MPa]  Water Potential at 2% loss conductivity
...
PsiX50_L = -10.0; %%[MPa]  Water Potential at 50% loss conductivity
...
%%% LOW VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_L = [0.010]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
Nl_L= [32]; %[kgC/kgN ] Leaf Nitrogen Concentration
...
dd_max_L=  [1/10];%%%0.005  [1/d]  0.0250 -- 0.005-0.025 death maximum for drought
...
age_cr_L= [100]; %% [day] Critical Leaf Age
Bfac_lo_L= [0.99]; %% PHENOLOGY Leaf Onset Water Stress [0-1]
Bfac_ls_L= [0.65]; %% PHENOLOGY Leaf Shed Water Stress [0-1]
...
Ws_under(1)=1; 
%%%%%%%%%%%%%% Volume [mm]
O(1,:)= [ 0.1386    0.1389    0.1398    0.1414    0.1434    0.1469    0.1526    0.1587    0.1649    0.1708    0.1758    0.1800    0.1835    0.1866, ... 
    0.1906    0.1949    0.2011    0.2071    0.2114    0.2148    0.2174    0.2209    0.2239    0.2329    0.2423]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
V(1,:) = (O(1,:) -Ohy).*dz;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
