...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% VEG. SPECIES 
%%% Upstore	-->  A homogenous mixture of evenly aged ponderosa pine with
%%% other trees and shrubs scattered throughout the ecosystem making up less than 30% of the biomass.
...
zatm = 12.5; %% Reference Height
%%%%%%%%%%%%%%%%%%
%%%% LAND COVER PARTITION
Cwat = 0; Curb = 0.0 ; Crock = 0.0;
Cbare = 0; Ccrown = [1.0];
%%%%%%%%%% SOIL INPUT %%% Fine-loamy,  
Pcla= 0.11; 
Psan= 0.60;
Porg= 0.03; 
Color_Class = 0;  
...
Oice = 0;
%%%
Zs= [0 10 50 100 200 300 400 600 800 1000 1250 1500 1750 2000 2500 3000 3500 4000 4500 5000]; %%% [ms+1] 
Zdes = 10;
Zinf=  10; 
Zbio = 250; 
...
dd_max_H= [1/300]; %%%0.005  [1/d]  0.0250 -- 0.005-0.025 death maximum for drought
dc_C_H =  78/365; %% [1/ d°C] -- [Factor of increasing mortality]
Tcold_H = [-20]; %% [°C] Cold Leaf Shed
drn_H=  [1/930]; %% turnover root  [1/d]
dsn_H= [1/800]; % normal transfer rate sapwood [1/d] 
age_cr_H= [750]; %% [day] Critical Leaf Age
...
%%%%%%%%%%%%%%%%
LAI_H(1,:)=[3.13]; %
B_H(1,:,:)= [313 508 448 357 6 0 18 0]; %%
Rrootl_H(1,:)= [5000] ;
PHE_S_H(1,:)=[1];
dflo_H(1,:)=[0];
AgeL_H(1,:)=[850];
...
%%%%%%%%%%%%%%%%%%%%%
   ...
   O(1,:)=  [ 0.2736    0.2756    0.2786    0.2831    0.2875    0.2908    0.2950    0.2979    0.2983    0.2940    0.2695    0.1984    0.1277    0.1595    0.1839    0.1963    0.2092 0.2194    0.2274]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
V(1,:) = (O(1,:) -Ohy).*dz;
