...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%Tropical pasture 
%%% Chamaecrista rotundifolia (Round-leaf cassia cv. Wynn), Digitaria milijiana (Jarra grass) and Aristida sp. standing at approximately 0.3m tall

%Tropical improved pasture (C4 grass and legume mixture), cleared 1982, low grazing pressure (~1 head ha-1),
%fire 1 in 5 years

%%GPP 1400  LAI 1.5 Ta 25.3  VPD 1400  Pr 1237  ET 740 

%%% Tower height 15 meters tall.
%%% Soil Red kandosol and deep sand.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Oice = 0;
%%%%%%%%%%%%%
Zs = [0 10 50 100 150 200 300 400 600 800 1000 1250 1500 1750 2000 2500 3000 3500 4000 4500 5000 5500 6000 6500 7000]; %%% [ms+1]
Zdes = 10;
Zinf=  10;
Zbio = 250;
...
KnitL=0.4; %%% Canopy Nitrogen Decay
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Psi_sto_50_L = -1.2;%  %% [MPa]  Water Potential at 50% loss conductivity
%%% Leaf
...
PsiX50_L = -8.5; %%[MPa]  Water Potential at 50% loss conductivity
...
%Mpar_L(1).jDay_cut=[10:120];
%Mpar_L(1).jDay_cut=[1:365];
%Mpar_L(1).LAI_cut=[-0.67]; %% -0.67 Grazing spread on the year  1 LU/ha 
%%%%
%%%%%%%%%%%% PRODUCTIVITY
Vmax_H = [0]; %
Vmax_L = [30]; %% 46
%%%%%%%%%%%%%%%%%%%%%%
%%%% Sim. GPP =1630 & LAI = 1.34 without grazing 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
LAI_L(1,:)=[0.0]; %
B_L(1,:,:)= [91 0 153 112 11 0 7 0]; %%
%B_L(1,:,:)= [464 0 580 387 29 0 19 0]; %%
Rrootl_L(1,:) = [4130] ;
PHE_S_L(1,:)=[3];
dflo_L(1,:)=[99];
AgeL_L(1,:)=[41];
...
Ws_under(1)=1;
%%%%%%%%%%%%%% Volume [mm]
O(1,:)=    [     0.1511    0.1613    0.1754    0.1845    0.1907    0.1975    0.2032    0.2096    0.2135    0.2149    0.2137    0.2095,...
    0.2060    0.2053    0.2085    0.2127    0.2164    0.2185    0.2116    0.1876    0.1753    0.1755    0.1771    0.1789]; 
%dz(ms)=ZWT(1)-Zs(ms);
%%%%%%%%%%%%%%%%%%%%%%%%
%Vmin= 0*dz;
%Vmax= (Osat-Ohy)*dz;
