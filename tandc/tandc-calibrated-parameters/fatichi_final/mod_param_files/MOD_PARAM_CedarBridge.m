...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%The Cedar Bridge site is located in the upland forests of the New Jersey Pine Barrens, the largest continuous forested landscape 
%on the Northeastern coastal plain. Upland forests occupy 62% of the 1.1 million acre Pine Barrens and can be divided into 
%three dominant stand types, Oak/Pine (19.1%), Pine/Oak (13.1%), and Pitch Pine/Scrub oak (14.3%). 

% Pitch Pine/Scrub oak stand (Cedar Bridge). 
%GPP 1380-1400 
...
%%%%%%%
LAI_H(1,:)=[3.5 0]; %
B_H(1,:,:)= [291 450 325 296 7 0 14 0; 
     145 244 162 79 11 0 1 0  ]; %%
