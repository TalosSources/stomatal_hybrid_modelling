...
%Quercus-Carya (oak hickory) forest, with important tree
%species including Quercus alba L. (white oak), Quercus velutina Lam.
%(black oak), Carya ovata (Mill.) K. Koch. (shagbark hickory), Acer saccharum
%Marsh. (sugar maple), and Juniperus virginiana L. (eastern redcedar),
%with Fraxinus americana L. (white ash)

%%% LAI peak 3.7-4.0 
% silt loam and clay loam soils 
%%% fine root 1350 gC /m2 
% 32 m tower 
%% canopy height 22m
%%% ET 4-5 mm/day summer GPP = 8 - 8.5 gC/m2 day 
%% Root depth  700 mm 
%% Soil depth 2 m // Ks = 1.44 mm/h 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% VEG. SPECIES 
%%%%%%%%%%%%%%%%%
cur_dir=cd;
...
Oice = 0;
%%%%%%%%%%%%%%
Zs = [0 10 50 100 150 200 300 400 500 600 800 1000 1250 1500 2000]; %%% [ms+1]
Zdes = 10;
Zinf = 50; 
Zbio = 250; 
...
LDay_cr_H = [12.6]; %%%  Threshold for senescence day light [h]
