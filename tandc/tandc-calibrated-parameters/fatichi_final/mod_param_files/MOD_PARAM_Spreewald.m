...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%  Tree Wetland  11% peatland   temperate fen  LAI = 3.6 
%%% GW depth average 10 cm below surface 
%%% NEE 1285 gC m-2 yr-1 
%WET (Permanent Wetlands: Lands with a permanent mixture of water and herbaceous or woody vegetation that cover extensive areas.
%The vegetation can be present in either salt, brackish, or fresh water)
%%%%%%%%%%%%%%%%%
%Alder forests on wetlands and pine forests on sandy dry areas are characteristic of the Spreewald region
%%%%%%%%%%%%%%%%%
cur_dir=cd;
cd(Directory)
...
LDay_min_L =[10.5]; %% Minimum Day duration for leaf onset
...
LDay_cr_L = [12.2]; %%%  Threshold for senescence day light [h]
