...
%%%%%%%%%%%%%%%%%%
%%%%%%% VEG. SPECIES  --- The main species of the uneven-aged forest is Norway
%Spruce (Picea abies (L.) Karst)) with tree heights between 20 and
%30 m, and a LAI of 5.5/5.1 NPP =450  GPP=1320 
...
Ha_H =[78]; %% [kJ / mol K]  entropy factor - Plant Dependent 
...
age_cr_H= [900]; %% [day] Critical Leaf Age
...
LDay_min_H =[14.05]; %% Minimum Day duration for leaf onset
...
LDay_cr_H = [9.45]; %%%  Threshold for senescence day light [h]
...
%%%%%%%%%%%%%%%%%%%%%
LAI_H(1,:)=[4.9]; %
B_H(1,:,:)= [374 880 468 588 8 0 16 0]; %%
Rrootl_H(1,:)= [4200] ;
PHE_S_H(1,:)=[1];
dflo_H(1,:)=[0];
AgeL_H(1,:)=[906];
