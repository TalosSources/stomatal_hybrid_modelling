...
% This station represents a typical alpine meadow ecosystem type in the northeast of Tibetan plateau.
% kobresia humilis meadow 3216m 

%Kobresia humilis meaodw mainly distributed in the gentle beach and semi-sunny slope mountain where the soil moisture is moderate.
%The dominant and companion species are Elymus nutans, Stipaaliena, Gen tiana straminea, Oxytropis kansuensis, Poa crmophila, and Poa praten. 
%The vegetation coverage can reach to 98% at the end of growing season. Canopy height is 25 cm. The NPP is between 330-467 g/m2 and the average value is 393.2 g/m2. 
% The soil is subalpine meadow soil. Content of organic matter and nitrogen of the soil in 0-40cm is 5.85% and 0.33% respectively.

%In the alpine
%ecosystem, plants start to grow in May and began to
%senesce in September. Leaf area index (LAI) reaches its
%maximum value of about 3 around mid-August when the
%average height of vegetation is about 30 cm and the
%vegetation coverage is over 90%
%%%%%%%%%%%%%%%%%
cur_dir=cd;
cd(Directory)
...
r_L = [0.072];  %% [0.066 -0.011]respiration rate at 10° [gC/gN d ]
...
LDay_cr_L = [13.0]; %%%  Threshold for senescence day light [h]
...
%Mpar_L(1).jDay_cut=[120:290];
%Mpar_L(1).LAI_cut=[-0.469]; %% [gC /m^2 d]
%%%%%%%%%%%%% PRODUCTIVITY
