...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%graminoid small-tussock steppe
%fine surface texture and a proportion of clay ranging between 35 and 60
%% NPP=480  
...
Oice = 0;
%%%%%%%%%%%%%
Zs = [ 0 10 20 50 100 150 200 250 300 400 500 600 700 800 ]; %%% [ms+1]
Zdes = 10;
Zinf=  10;
Zbio = 250;
...
KnitL=0.2; %%% Canopy Nitrogen Decay
...
age_cr_L= [160]; %% [day] Critical Leaf Age
...
Ws_under(1)=1;
%%%%%%%%%%%%%% Volume [mm]
O(1,:)=  [ 0.3062    0.3062    0.3062    0.3062    0.3063    0.3063    0.3063    0.3064    0.3064    0.3065    0.3065    0.3066 0.3066];
