% %%%% Pinus-Taeda Commercial plantation
% 1800 mm, and mean temperature is 21.1
% GPP = 4000-4200 gC/m2 yr
% ET= 1130-1160  
% tower at 18 m above the ground and at 6 m above the canopy 72% humidity 
% 1.5 m soil clayish texture, good drainage
% Trees aged 6 and ended when they were 8 years.
...
rjv_H=[2.2]; %%% Ratio Jmax - Vmax  [umol electrons / umolCO2 ]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%------
...
Sl_H = [0.012]; %  [m^2 gC] specific leaf area of  biomass [m^2 /gC] 0.05 -0.005
...
Tlo_H = [12]; %% Mean Temperature for Leaf onset
Tls_H = [NaN]; %%% Not-used 
PAR_th_H= [NaN]; %% Light Phenology Threshold 
dmg_H= [45]; %%%  Day of Max Growth
LAI_min_H = [0.001];
mjDay_H = [-150]; %% Maximum Julian day for leaf onset
...
%%%%%%%%%%%%%%
LAI_H(1,:)=[3]; %
B_H(1,:,:)= [389 734 432 459 23 0 16 0]; %% 
Rrootl_H(1,:)= [0] ;
PHE_S_H(1,:)=[3];
dflo_H(1,:)=[110];
AgeL_H(1,:)=[496];
