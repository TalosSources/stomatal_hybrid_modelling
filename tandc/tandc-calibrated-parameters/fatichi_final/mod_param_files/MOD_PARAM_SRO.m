...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% VEG. SPECIES 
%%% Upstore	--> Pinus pinaster Quercus Ilex, Pinus pinea 
%%% Understore --> Erica arborea, Phyllirea angustifolia,
%%% Rhamnus alaternus, Myrtus communis    
...
Oice = 0;
%%%
Zs= [0 10 50 100 200 300 400 600 800 1000 1250 1500 1750 2000 2500 3000 4000 5000]; %%% [ms+1] 
Zdes = 10;
Zinf=  10; 
Zbio = 250; 
...
KnitL= 0.5; 
mSl_H = 0.002;%% [m2 PFT /gC]  Linear increase in Sla with LAI 
...
DSE_H =[0.640];  %% [kJ/mol] Activation Energy - Plant Dependent 
Ha_H =[50]; %% [kJ / mol K]  entropy factor - Plant Dependent 
...
%%% HIGH VEGETATION
%%%%%%%%%%%%%%%%%%%%%%%%%
Sl_H = [0.008]; % 0.05 -0.005 [m^2 gC] specific leaf area of  biomass [m^2 /gC]
...
dd_max_H= [1/250]; %%%0.005  [1/d]  0.0250 -- 0.005-0.025 death maximum for drought
dc_C_H =  78/365; %% [1/ d°C] -- [Factor of increasing mortality]
Tcold_H = [-10]; %% [°C] Cold Leaf Shed
drn_H=  [1/1230]; %% turnover root  [1/d]
...
Tlo_H = [9.7]; %% Mean Temperature for Leaf onset
